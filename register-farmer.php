...
// 	$specialchars = preg_match('@[^\w]@', $password);
 ...
 $sql="INSERT INTO users (username, email, user_type, password, tax_number) 
 VALUES('$username', '$email', 'admin', '$password', '$taxnumber')";
$result = mysqli_query($conn, $sql);
...
<div id="login-form">
  ...
  <form id="register-form"  method="POST">
    ...
    <p>
    <input type="text" name="taxnumber" placeholder="Tax Number" required autocomplete="off">
    </p>
    <p>
  ...
  <div id="create-account">
    <p>Have already an account ?  <a href="login-farmer.php">Login</a><p>
  </div>
</div>  
