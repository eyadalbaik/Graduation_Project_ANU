...
$sql440 = "SELECT code,quantity,price  FROM  ve  where code=".$_SESSION['food2'];
// group  by code";
...
//$row440 = mysqli_fetch_assoc($result440);
...
//echo "<td><a href='index.php?id=".$row3['id']."'>Show</a></td>";
        ...
        echo "<td>". $row440["code"]." </td>" . "<td> ". $row440["quantity"]."</td><td>".$row440["price"]."</td>";
		//"<td>".$row3["details"]."</td><td><a href='delete.php?id=".$row3['id']."'>DELETE</a>"."</td>"." " . "<br>";
        echo "<td><a href='products2.php?name=".$row440["code"]."'>";
        echo "Details</a></td>";
echo "</tr>";
  //echo "</br>h9</br>";
